        ...
        if(result.data.QueryCNReport.length != 0){
          ...
          result.data.QueryCNReport.forEach(function (val, i) {
            ...
            <tr>
                            ...
                            <td align="left">{val.SaleID}</td>
                            <td align="left">{val.INVOICEID}</td>
                            <td align="left">{val.CustomerID}</td>
                            <td align="right">{val.QtyBill}</td>
                            <td align="right">{this.formatMoney(val.AmountBill)}</td>
                            <td align="left">{val.Datetime}</td>
                            <td align="right">{this.formatMoney(val.AmountActual)}</td>
                            <td align="right">{this.formatMoney((val.QtyBill)-(val.QtyActual))}</td>
                            <td align="right">{this.formatMoney((val.AmountBill)-(val.AmountActual))}</td>
                            <td align="right">{this.formatMoney((val.QtyBill)- ((val.QtyBill)-(val.QtyActual)))}</td>
                            <td align="left">{val.ReasonCN}</td>
                    ...
                    <Table responsive>
                      <thead>
                        <tr>
                          ...
                          <th width = "10%"><center>Sale</center></th>
                          <th width = "5%"><center>invoice</center></th>
                          <th width = "10%"><center>ลูกค้า</center></th>
                          <th width = "10%"><center>Qty ยอดจริง</center></th>
                          <th width = "10%"><center>ยอดเงินจริง</center></th>
                          <th width = "10%"><center>วันที่เคลียร์บิล</center></th>
                          <th width = "10%"><center>ยอดเงินที่เก็บได้</center></th>
                          <th width = "10%"><center>จำนวน CN</center></th>
                          <th width = "10%"><center>ยอด CN</center></th>
                          <th width = "10%"><center>จำนวนคงเหลือ</center></th>
                          <th width = "10%"><center>เหตุผล</center></th>
                        </tr>
                      </thead>
                      <tbody>
